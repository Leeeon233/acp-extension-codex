...
describe("typed session failures over ACP transport", () => {
    ...
    it("delivers an app-server warning as structured Codex metadata instead of assistant text", async () => {
    ...
    it("folds a config warning's details into structured Codex metadata", async () => {
    ...
    it("preserves long config warning details in Codex metadata", async () => {
    ...
    it("keeps warnings out of assistant text when the capability is absent", async () => {
    ...
    it("keeps Codex warning metadata separate from an active typed failure", async () => {
    ...
    it("publishes repeated warnings as independent structured notices", async () => {
    ...
    it("preserves warning order when messages recur", async () => {
